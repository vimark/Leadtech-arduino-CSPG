...
byte meter_identity[]    = {'C', 'S', 'P', 'G', ' ', 'M', 'E', 'T', 'E', 'R', ' ', '0', '0', '0', '6', 0x00 };
...
void loop() {
    ...
    Serial.println(F(" ..."));
    dump_byte_array(cspg_uid, 16); Serial.println();
    status = (MFRC522::StatusCode) mfrc522.MIFARE_Write(blockAddr, cspg_uid, 16);
    if (status != MFRC522::STATUS_OK) {
